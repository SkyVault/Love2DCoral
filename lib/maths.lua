return function(vault)
  ...
  function v2(x, y)
    return vault.table("v2", function(self)
      setmetatable(self, {
        __tostring = function(this)
          return string.format("%0.2f %0.2f", this.x, this.y)
        end,
  ...
  function v3(x, y, z)
    return vault.table("v3", function(self)
      ...
      magnitude = function(self) return math.sqrt(self.x ^ 2 + self.y ^ 2 + self.z ^ z) end,
